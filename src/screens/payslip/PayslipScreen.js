    ...
    return (
        <View style={{ backgroundColor: "#fff", width: "100%", height: "100%" }}>
            ...
            <View style={{ ...commonStyles.rowBetween, padding: 14 }}>
                <Text style={{ ...commonStyles.fs14_400, color: "#0073FF" }}>Financial Year</Text>

                <TouchableOpacity style={styles.yearBtn}>
                    <Text style={{ ...commonStyles.fs14_400, color: "rgba(0,104,158,0.9294117647058824 )" }}>2021-2022</Text>
                    <Image
                        source={require("../../assets/img/down-arrow.png")}
                        resizeMode="contain"
                        style={{ width: 14, height: 14, tintColor: "rgba(0,104,158,0.9294117647058824 )" }}
                    />
                </TouchableOpacity>
            </View>
