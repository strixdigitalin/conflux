...
export default function CalendarScreen({ navigation, route }) {
  ...
  const [markedDates, setMarkedDates] = useState({
    '2022-12-20': { textColor: 'green' },
    '2021-12-22': { startingDay: true, color: 'green' },
    '2021-12-23': { selected: true, endingDay: true, color: 'green', textColor: 'gray' },
    '2021-12-04': { disabled: true, startingDay: true, color: 'green', endingDay: true }
  })
